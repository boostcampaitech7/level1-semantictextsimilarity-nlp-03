...
def main(checkpoint_path):
    ...
    # 5. inference
    train_result, train_outputs = inference(
        train_dataloader, model, criterion, metrics, device
    )
    test_result, test_outputs = inference(
        test_dataloader, model, criterion, metrics, device
    )
